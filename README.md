...
[![npm](https://img.shields.io/npm/v/peasy-gen-embed)](https://www.npmjs.com/package/peasy-gen-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/peasy-gen-embed)
[![Size](https://img.shields.io/badge/gzipped-<8KB-green)](https://bundlephobia.com/package/peasy-gen-embed)

Embed **PeasyGen** widgets on any website or blog. Generator tools — lorem ipsum, UUIDs, fake data, and sample content. Each widget is completely isolated via **Shadow DOM**, requires **zero dependencies**, and supports **3 built-in themes** (light, dark, sepia). The self-executing script finds all `data-peasy-gen` elements on the page and renders interactive widgets automatically, including support for dynamically added elements in single-page applications via MutationObserver.

PeasyGen is part of the [Peasy Tools](https://peasytools.com) ecosystem, providing 11 widget types for embedding file format information, tool cards, conversion guides, glossary terms, search boxes, and interactive tools directly into your pages.

> **Try the interactive widget builder at [widget.peasygen.com](https://widget.peasygen.com)** -- build, preview, and copy embed code for any widget type.

<p align="center">
  <img src="demo.gif" alt="peasy-gen-embed demo -- embed peasygen widgets with Shadow DOM isolation and theme support" width="800">
</p>
...
<div data-peasy-gen="tool"
  data-slug="uuid-generator"
  data-theme="light">
</div>

<!-- 2. Load the embed script once, anywhere on the page -->
<script src="https://cdn.jsdelivr.net/npm/peasy-gen-embed@1/dist/embed.min.js"></script>
```

That's it. The script will find all `data-peasy-gen` elements, fetch data from the PeasyGen API, and render each widget with full Shadow DOM style isolation.

## Widget Types

PeasyGen supports 11 widget types -- 11 common types available on all Peasy sites.

| Type | Description | Usage |
|------|-------------|-------|
| `format` | File format info card with specs, MIME type, and use cases | `<div data-peasy-gen="format" data-slug="..."></div>` |
| `tool` | Tool card with description and direct launch link | `<div data-peasy-gen="tool" data-slug="..."></div>` |
| `convert` | Conversion card showing input/output format pair | `<div data-peasy-gen="convert" data-slug="..."></div>` |
| `compare` | Side-by-side comparison of two formats or tools | `<div data-peasy-gen="compare" data-slug="..."></div>` |
| `glossary` | Glossary term tooltip with definition on hover | `<div data-peasy-gen="glossary" data-slug="..."></div>` |
| `gallery` | Grid gallery of available tools for a category | `<div data-peasy-gen="gallery" data-slug="..."></div>` |
| `guide` | Guide/tutorial card with summary and read-more link | `<div data-peasy-gen="guide" data-slug="..."></div>` |
| `usecase` | Use-case card showing when and why to use a tool | `<div data-peasy-gen="usecase" data-slug="..."></div>` |
| `badge` | Inline badge showing format type or tool category | `<div data-peasy-gen="badge" data-slug="..."></div>` |
| `search` | Search box with autocomplete for tools and formats | `<div data-peasy-gen="search" data-slug="..."></div>` |
| `interactive` | Embedded interactive tool via iframe | `<div data-peasy-gen="interactive" data-slug="..."></div>` |
...
|-----------|--------|---------|-------------|
| `data-peasy-gen` | format, tool, convert, compare, glossary, gallery, guide, usecase, badge, search, interactive | *required* | Widget type to render |
...
<div data-peasy-gen="tool" data-slug="uuid-generator" data-theme="light"></div>

<!-- Dark theme -- dark background, light text -->
<div data-peasy-gen="tool" data-slug="uuid-generator" data-theme="dark"></div>

<!-- Sepia theme -- warm, paper-like appearance -->
<div data-peasy-gen="tool" data-slug="uuid-generator" data-theme="sepia"></div>

<!-- Auto theme -- follows prefers-color-scheme -->
<div data-peasy-gen="tool" data-slug="uuid-generator" data-theme="auto"></div>
```

Each theme sets CSS custom properties inside the Shadow DOM. The accent color (`#84CC16`) is consistent across all themes, providing brand recognition for PeasyGen.
...
```html
<script type="module">
  import 'https://cdn.jsdelivr.net/npm/peasy-gen-embed@1/dist/embed.esm.js';
</script>
```
...
```html
<!-- PeasyGen format info card with light theme -->
<div data-peasy-gen="format" data-slug="uuid-generator" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-gen-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Search across PeasyGen tools and formats -->
<div data-peasy-gen="search"
  data-placeholder="Search PeasyGen tools..."
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-gen-embed@1/dist/embed.min.js"></script>
```
...
```html
<p>This file is in <div data-peasy-gen="badge" data-slug="uuid-generator"></div> format.</p>
<script src="https://cdn.jsdelivr.net/npm/peasy-gen-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Embed an interactive PeasyGen tool -->
<div data-peasy-gen="interactive"
  data-slug="gen/example-tool"
  data-height="500"
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-gen-embed@1/dist/embed.min.js"></script>
...
> **Note:** The `data-slug` value uses the format `category-slug/tool-slug`. Find available tools at [peasygen.com/api/v1/tools/](https://peasygen.com/api/v1/tools/).
...
```html
<div data-peasy-gen="glossary" data-slug="lossless" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-gen-embed@1/dist/embed.min.js"></script>
```
...
- **CORS**: PeasyGen API has CORS enabled for all origins
...
- **Powered by**: Each widget includes a subtle "PeasyGen" backlink in the footer

## Learn More

Visit [peasygen.com](https://peasygen.com) for the full PeasyGen experience.

- **All Tools**: [peasygen.com](https://peasygen.com)
- **Formats**: [peasygen.com/formats/](https://peasygen.com/formats/)
- **Glossary**: [peasygen.com/glossary/](https://peasygen.com/glossary/)
- **Guides**: [peasygen.com/guides/](https://peasygen.com/guides/)
- **API Documentation**: [peasygen.com/developers/](https://peasygen.com/developers/)
- **OpenAPI Spec**: [peasygen.com/api/openapi.json](https://peasygen.com/api/openapi.json)
- **Widget Builder**: [widget.peasygen.com](https://widget.peasygen.com)
- **npm Package**: [npmjs.com/package/peasy-gen-embed](https://www.npmjs.com/package/peasy-gen-embed)
...
Embed [PeasyGen](https://peasygen.com) widgets on any website with [peasy-gen-embed](https://widget.peasygen.com):

```html
<script src="https://cdn.jsdelivr.net/npm/peasy-gen-embed@1/dist/embed.min.js"></script>
<div data-peasygen="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.peasygen.com)
